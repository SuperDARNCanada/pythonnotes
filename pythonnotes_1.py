...
sure the programmer doesnt have to worry about segfaults and io errors. Errors
are usually given with a detailed stack trace so that you dont need complicated
debugging methods.
...
The six standard Python data types are:
    Number
    Boolean
    String
    List
...
or object reference. == or != tests value equality whereas 'is' or 'is not' tests
